...
# Version 10 is Fable, the model that passed qualification, with a 120s timeout. It also
# carries the live issue-search fix and the refusals that name a next step. Version 9
# predates both; version 8 is Opus, which failed the claim-to-evidence gate at 0.743.
QUALIFIER = "10"
