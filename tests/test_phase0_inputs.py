...
def test_each_active_prompt_owns_its_required_boundary() -> None:
    required_by_prompt = {
        ...
        "answer.md": (
            ...
            "use the minimum number of claims needed to answer the exact question",
            "prefer one claim for a single-fact question",
            "do not add background, definitions, capabilities, commands",
            "schedules, status, roadmap, warnings, or adjacent facts",
